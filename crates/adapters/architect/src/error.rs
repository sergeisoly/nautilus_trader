...
//! Unified error handling for the Architect adapter.
//!
...
/// The main error type for all Architect adapter operations.
#[derive(Debug, Error)]
pub enum ArchitectError {
    ...
    Retryable {
        #[source]
        source: ArchitectRetryableError,
    ...
    NonRetryable {
        #[source]
        source: ArchitectNonRetryableError,
    },
...
#[derive(Debug, Error)]
pub enum ArchitectRetryableError {
...
#[derive(Debug, Error)]
pub enum ArchitectNonRetryableError {
